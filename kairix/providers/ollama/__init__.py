"""Ollama (local) provider plugin (scaffold).
...
def make_provider() -> Provider:
    """Construct the Ollama ``Provider`` (Wave 4).
    ...
    raise NotImplementedError(
        "ollama provider lands in Wave 4 (follow-up to issue #247). "
